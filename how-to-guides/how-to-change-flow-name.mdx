...
1. **Show your flow:** First, ensure that you have a flow to work with. If you haven't created a flow yet, you can refer to the article on [How to create a flow](https://docs.peaka.com/flows/how-to-create-a-flow/) for guidance.
