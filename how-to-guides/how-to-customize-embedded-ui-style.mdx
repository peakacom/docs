---
title: "How to customize Embedded Peaka UI"
description: "Learn how you can update the Peaka's UI according to your application"
---
...
<Note>Note: It should be imported the font families that you mentioned in the font family variable.</Note>
```css
