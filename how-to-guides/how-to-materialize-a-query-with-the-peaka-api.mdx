...
This reads the stored table directly — it is fast and does not touch the underlying connectors. You can run it anywhere you run SQL against your project, for example with the [Execute Query](/api-reference/data--queries/execute-query) endpoint, a [JDBC driver](https://www.peaka.com/docs/db-drivers/java), or from other Peaka queries.
