...
Note: Users can establish a data source to their MySQL database on AWS by leveraging IAM credentials. For more details, refer to the [article on Peaka's documentation](https://www.peaka.com/docs/how-to-guides/how-to-connect-databases-in-aws-using-iam-credentials/).
