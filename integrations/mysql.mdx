...
Note: Users can establish a data source to their MySQL database on AWS by leveraging IAM credentials. For more details, refer to the [article in Peaka's documentation](https://docs.peaka.com/how-to-guides/how-to-connect-databases-in-aws-using-iam-credentials/).
