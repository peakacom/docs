...
- Adding Peaka as Database Connection to Preset is so easy. In your main dashboard in Preset, click Setting and then click Database Connections.
...
<img
  ...
  style={{ border: "1px solid #e2e4e7" }}
/>
- Installation is complete you should be able to see Peaka in Database Connections
List. You can start using Peaka with Preset.
