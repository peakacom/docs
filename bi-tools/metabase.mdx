...
Check out Peaka Documentation for creating your API Key and follow detailed instructions by clicking [here](https://www.peaka.com/docs/how-to-guides/how-to-generate-api-keys/).
...
- Add database form will open and you need to add your connection details on this screen. Select Starbust for Database Type.
  Then give a name to your database connection. For the host name enter dbc.peaka.host. For the port enter 4567.
