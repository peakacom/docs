...
After you create your project, setup connections and create your catalogs in Peaka, you need to generate a Peaka API Key to use it with Tableu Connector. Check out Peaka Documentation for creating your API Key and follow detailed instructions by clicking [here](https://www.peaka.com/docs/how-to-guides/how-to-generate-api-keys/).
...
- [PeakaWebDataConnector-1.0.0.taco](https://cdn.peaka.com/files/PeakaWebDataConnector-1.0.0.taco)
