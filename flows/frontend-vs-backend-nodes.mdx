...
description: "Click here to learn about the difference between frontend and backend nodes in Peaka"
---

This article provides an overview of frontend, backend, and common nodes in Peaka and explains their respective roles.

<img
  src="https://cdn.peaka.com/jexl/flows/frontend-vs-backend-nodes-1.png"
