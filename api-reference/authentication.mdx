...
- **Partner API Key**: Grants access to all resources for partner-level access. [Learn how to manage a Partner API Key](https://www.peaka.com/docs/cookbook/how-to-manage-partner-api-key)
- **Project API Key**: Grants access to resources specific to the project for which the key was created. [Learn how to generate API Keys](https://www.peaka.com/docs/cookbook/how-to-generate-api-keys)
