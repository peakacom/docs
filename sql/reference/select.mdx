...
For description of table functions usage, see [table functions](/sql/functions/table.mdx).
...
supported statements, and examples in [routines](/sql/sql/routines/introduction.mdx).
