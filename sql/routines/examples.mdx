...
introduction](/sql/routines/introduction.mdx), the following sections show numerous
...
* [function](/sql/routines/function.mdx) for general SQL routine declaration
* [begin](/sql/routines/begin.mdx) and [declare](/sql/routines/declare.mdx) for routine blocks
* [set](/sql/routines/set.mdx) for assigning values to variables
* [return](/sql/routines/return.mdx) for returning routine results
* [case](/sql/routines/case.mdx) and [if](/sql/routines/if.mdx) for conditional flows
* [loop](/sql/routines/loop.mdx), [repeat](/sql/routines/repeat.mdx), and [while](/sql/routines/while.mdx) for looping constructs
* [iterate](/sql/routines/iterate.mdx) and [leave](/sql/routines/leave.mdx) for flow control
...
Trino already has a built-in `bar()` [color function](/sql/functions/color.mdx), but
...
Trino already has a built-in [aggregate function](/sql/functions/aggregate.mdx) called
