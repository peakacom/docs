...
SQL routines can use [`CASE` statements](/sql/routines/case.mdx) that use a slightly
...
SQL routines can use [`IF` statements](/sql/routines/if.mdx) that use a slightly
