---
title: "JDBC Driver"
description: "Welcome to the documentation for the Peaka JDBC Driver – your gateway to seamless integration with the powerful Peaka data platform.
...
For feature requests and bugs, please create an issue in [this](https://github.com/peakacom/peaka-jdbc-driver) repo. For further support, see the following resources:
